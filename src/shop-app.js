...
class ShopApp extends PolymerElement {
  static get template() {
    ...
    <dom-if if="[[_shouldRenderDrawer]]">
      ...
      <app-drawer opened="{{drawerOpened}}" swipe-open="" tabindex="0">
        <iron-selector role="navigation" class="drawer-list" selected="[[categoryName]]" attr-for-selected="name">
          ...
          <a name="about" href="/about">About Shop</a>
        </iron-selector>
      </app-drawer>
      </template>
    </dom-if>
    ...
    <iron-pages role="main" selected="[[page]]" attr-for-selected="name" selected-attribute="visible" fallback-selection="404">
      ...
      <!-- about view -->
      <shop-about name="about"></shop-about>
      <!-- fallback view -->
...
`;
  ...
  _computeShouldShowTabs(page, smallScreen) {
    return (['home', 'list', 'detail', 'about'].indexOf(page) !== -1) && !smallScreen;
  }
